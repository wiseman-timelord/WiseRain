...
### STATUS
Beta. After hours of leaving the given panels on, there will likely be a hard-crash; I have already attempted to fix this. Its presumed, Rainmeter and/or the plugin PowershellRM and/or some of the Powershell Cmdlets themselves, are not designed to be spammed with stop/start commands...
