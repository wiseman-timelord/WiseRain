...
- Button on network panel, to enable/disable bandwidth monitoring, ie, "ooo whats using the bandwidth" *click* "oh.." *click*. Attempt 1 fail, possibly needs separate folder, or different syntax.
